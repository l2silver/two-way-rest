...
export function checkTWREntries(_globe, _firstInstance, _tree){
	...
	//console.log('checkTWREntriesTime', new Date().getTime() - startTime,_firstInstance.toJS())
...
export function wrapMapState(js, tree, globe = Map()){
	const startTime = new Date().getTime();
	const nextState = mapState(js, tree, globe.asMutable());
	console.log('mapStateTime', new Date().getTime() - startTime, js, tree.toJS());
