...
export const StupidTWRCreateChild = React.createClass(defaultProperties
	.merge(defaultPostCreateProperties)
	.merge(defaultCreateChildProperties)
	.toJS())

export const StupidTWRCreateChildFront = React.createClass(defaultProperties.merge(defaultPostCreateProperties).merge(defaultCreateChildProperties)
	.merge({
		submitForm: function(event){
		event.preventDefault();
