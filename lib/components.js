...
export const StupidTWRDestroy = React.createClass(defaultPostUpdateProperties.merge(defaultPostRenderClickProperties).merge({
	submitForm: function(event){
		event.preventDefault();
...
export const StupidTWRUpload = React.createClass(defaultProperties.merge(defaultPostProperties.merge(defaultPostRenderProperties)).merge({
	submitForm: function(event){
		event.preventDefault();
